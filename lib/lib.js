...
const cond2 = pairs => (...x) => pipe(
	append([TRUE, UNDEF]),
	transpose,
	_lift(idx)( head, findIndex(t(...x)) )(last)
)(pairs);
...
const traverse = A => f => dispatch("traverse")(A, f)(
...
const contramap = f => dispatch("contramap")(f)(
	[isF,  contramapf(1)(f)]
);
...
const alt = y => dispatch("alt")(y)();
const zero = dispatch("zero")()();
const composeS = g => dispatch("compose")(g)(
	[isF, map(g)]
);
const idC = dispatch("id")()(
	[eq(Function), k(id)]
);
