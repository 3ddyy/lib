...
import { contramapf, mapf, liftf, pipe, double, t, id } from "./function.js";
import { map, reduce, lift } from "./category_theory.js";
import {
	mapi, transpose, append, head, last, idx, findIndex
} from "./array.js";
...
export {
	...
	not, and, or, xor,
	eq, equals, eqBy, ineq,
	complementf, complement, bothf, both, eitherf, either,
	alli, anyi, all, any,
	ifelse, when, unless,
	cond2, cond
};
